...
export function BuilddeckGuide() {
  gaTrackView("/Basics/BuilddeckGuide");
  return (
        ...
        <div className="subSectionDesc">
          ...
          <ul className="bb_ul">
            <li>
              ...
              <br />
              <b>Team Synergies</b>:<br />
              Settsu can synergize well with any master since she's a hero that works indipendently
              with a good deck, and can really save the day if your teammate is not really strong.
              <br />
