  ...
  return (
    <div className="subSection detailBox" id={2894047}>
      ...
      <div className="subSectionDesc">
        ...
        <br />
        To do that, you just need to increase the glory of your deck (the glory is indicated by the
        number in the big star near your deck). Leveling up cards doesn't give you any advantage in
        game, but increase the card glory, and the total glory is exactly how many points you get
        when you win a battle as progress through the season.
        <br />
        During the season you earn gold stars (up to 4 at tier 54), and each gold star will turn a
        card with the lowest glory to 400 (400 is the max glory that a card can have). Duplicate
        cards count as 0 glory so be careful!
        <br />
        ...
        when you earn all 3 (by winning 3 times), all that glory will be added to your total
        progress, which means that you will gain several tiers (up to 3 with max glory). So if you
        don't have much time to play, 3 victories at day with an high glory deck is the way to go!
        <br />
