    ...
    return <div>
        ...
        <Tabs>
            <TabList>
                ...
                <Tab>
                    <img className={css.MasterAbilityImageRoundedStyle} src="generated/img/Arcane_Golem_78.webp"
                         alt="Miloween Perk1"/>
                </Tab>
                <Tab>
                    <img className={css.MasterAbilityImageRoundedStyle} src="generated/img/Arcane_Missiles_78.webp"
                         alt="Miloween Perk2"/>
                </Tab>
                <Tab>
                    <img className={css.MasterAbilityImageRoundedStyle} src="generated/img/Tome_of_Lore_78.webp"
                         alt="Miloween Perk3"/>
                </Tab>
            </TabList>
