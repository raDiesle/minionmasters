  ...
  return (
    <div>
      ...
      <Tabs>
        ...
        <TabPanel>
          <div className={css.MasterAbilityHeaderStyle}>Long Shot</div>
          <div className={css.MasterAbilityDescriptionStyle}>
        ...
        <TabPanel>
          <div className={css.MasterAbilityHeaderStyle}>Aerodynamics</div>
          <div className={css.MasterAbilityDescriptionStyle}>
        ...
        <TabPanel>
          <div className={css.MasterAbilityHeaderStyle}>Lightning Reflexes</div>
          <div className={css.MasterAbilityDescriptionStyle}>
