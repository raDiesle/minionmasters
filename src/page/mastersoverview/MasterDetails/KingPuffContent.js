  ...
  return (
    <div>
      ...
      <div className={css.MasterAbilityDescriptionStyle}>
        King Puff is a trickster, he loves to confuse his opponents and keep
        bridge control just as he loves kingdom control.
      </div>
      ...
      <Tabs>
        ...
        <TabPanel>
          <div className={css.MasterAbilityHeaderStyle}>Basic Attack</div>A slow
          but powerful attack dealing 75 damage to a single unit every 2.5 sec,
          with a range of 8.
        </TabPanel>
        <TabPanel>
          ...
          <div className={css.MasterAbilityDescriptionStyle}>
            Swaps the location of ALL minions on both bridges and Stuns enemies
            for 4 sec.
          </div>
        ...
        <TabPanel>
          ...
          King Puff's 4 and 5 mana Minion Cards gain either Rage or Shield when
          played.
        ...
        <TabPanel>
          ...
          <div className={css.MasterAbilityDescriptionStyle}>
            King Puff marks the bottom bridge and is immune to damage when
            controlling the marked bridge.
          </div>
          <div className={css.MasterAbilityDescriptionStyle}>
