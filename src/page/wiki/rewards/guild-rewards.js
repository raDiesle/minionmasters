...
import css from "page/wiki/rewards/guild-rewards.scss";
    ...
    <div>
      ...
      <div>
        ...
        <div>
          ...
          victories in conquest mode each cycle, and they can lose up to 3 times. Once you win 6
          times or lose 3, you cannot contribute anymore until the next cycle.
          <br />
          <br />
          ...
          the guild pass. If your conquest mode is active, the guild emblem will be visible near the
          usual "Battle" button to start a game.
          <br />
          <br />
          <br />
          <br />
          ...
          remember that once you have lost 3 times there is no way to try again (is not like drafts
          or mayhem where you can buy a new ticket and try again), so if you are having a lose
          streak, remember to pause the conquest and to resume at better times.
          <br />
          <br />
          <u>
            <b>NOTE 2:</b>
