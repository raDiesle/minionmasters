...
export default function InfoDetailsCardOverlay({card, isFullWidthClickable = false}) {
    ...
    return <>
        ...
        <div className={css.InfoDetailsOverlay}
             style={{padding: isFullWidthClickable ? '50% 0 36% 100%' : '50% 0 36% 30%'}}
             onClick={(event) => {
                 setIsOpenDetails(true);
                 event.stopPropagation();
             }}>
            {
                isFullWidthClickable === false && <div className={css.InfoIconStyle}>
