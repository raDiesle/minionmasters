...
const newManualCards = [
  ...
  {
    "catagory": "Standard",
    "name": "Protocol 45.54.55-1N",
    "manacost": 6,
    "type": "Minion",
    "rarity": "Legendary",
    "imageName": "RobotNinja",
    "description": "Every 8 seconds gain Arc Slash. Arc Slash: Instead of attacking, Protocol 45.54.55-1N moves forward in an instant, dealing heavy damage to all ground enemies in its path.",
    "isAOE": false,
    "ExcludeFromRandom": false,
    "Faction": "Outlander",
    "CardCount": 3,
  ...
  },
  {
    ...
    "type": "Spell",
    "rarity": "Rare",
    "imageName": "ArcaneNullifier",
    "description": "Remove all positive effects on Minions in an Area, then deal 100 damage to all enemies in the area.",
    "isAOE": false,
    "ExcludeFromRandom": false,
    "Faction": "Outlander",
    "CardCount": 3,
