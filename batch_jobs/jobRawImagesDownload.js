...
const TARGET_FOLDER = "./batch_jobs";
...
async function fetchImageData() {
  ...
  let url =
    "https://minionmasters.gamepedia.com/api.php?action=query&list=allimages&ailimit=max&aiprop=timestamp|url&aisort=timestamp&aidir=older&format=json";
